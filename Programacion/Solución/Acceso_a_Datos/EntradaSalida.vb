...
Public Class EntradaSalida
    ...
    Public Function LeerCSVIdioma(archivo As String) As DataTable
    ...
    Public Function LeerCSV(path As String, columnas As List(Of String))

        Dim reader As New StreamReader(path)
        Dim tabla As New DataTable
        Dim datos As String()

        For Each nombre As String In columnas
            tabla.Columns.Add(nombre, GetType(String))
        Next
        ...
        While Not reader.EndOfStream
            ...
            If linea <> "" Then
                ...
                If datos.Count = tabla.Columns.Count Then
                    tabla.Rows.Add(datos)
                End If
